        ...
        <div className='container pt-16 pb-16 grid-cols-2'>
            ...
            <div className='grid lg:grid-cols-[300px,1fr] gap-4'>
                <div className='border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0'>
                    <div className='text-center flext-col items-center gap-1'>
                        ...
                        <p className='max-w-[200px] text-gray-500'>
                            Lorem issum dolor sit amet consectetur Lorem ipsum dolor dolor sit amet.
                        </p>
                    </div>
                ...
                <div className='bg-red-600 bg-[url(/cta-banner.jpg)] bg-cover h-[500px] rounded-2xl grid place-items-center'>
                    <div className='bg-[#ffffffab] min-w-[270] sm:min-w-[300px] md:min-w-[500px] rounded-xl py-8 sm:px-8 grid place-items-center gap-3'>
                        <button className='bg-blackish text-white p-2 rounded-md'>
                            25% DISCOUNT
                        </button>
                        <h2 className='text-extrabold text-2xl text-[#272727]'>
                            Summer Collection
                        </h2>
                        <p>
                            Starting &coyy; $20 <b>Shop Now</b>
                        </p>
